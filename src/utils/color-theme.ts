...
//this file is used to define the color themes for the app. it is a reflection of the tailwind.config.js file. and uses the definitions from the global.css file.
